...
export const ui = {
  ...
  en: {
    ...
    'placeholder.about.body':         'I have been developing in .NET since 2018, and over that time I have worked on very different projects: traceability systems for the European Commission, financial systems, a sports streaming OTT platform, an incentives calculation platform, and currently a legaltech platform for regulatory (GDPR) compliance as a Senior Backend Developer. What drives me is well-crafted quality and performance challenges — the kind of problems where the improvement is visible and measurable. I am meticulous about process, I believe in teamwork and collaboration over individual recognition, and I always keep the drive to learn and improve. Open to new opportunities.',
